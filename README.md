...
The BPIC2017 dataset is too large to just upload to GitHub directly, so replicating this takes slightly more steps. Accordingly we also included the results of these verification in .txt files in the 17\_results directory.

1. Git Clone
2. Move to the dataset\real directory `cd Datasets\Real` 
3. Download the BPIC2017 dataset into the Datasets\Real directory from: 
